...
## Overview
The ANS snippet application shows how to initialize and use the WICED BT Alert
Notification Server library. ANS is implemented in GAP central mode and provides ANS services to ANC devices using WICED BT ANS library.

## Features demonstrated
- Initialize and use the WICED BT ANS library
